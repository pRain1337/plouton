...
/*
* Function:  initCorsairWirelessAudioXHCI
* --------------------
* Tries to initialize the audio driver for the Corsair Wireless Headset.
*
*  returns:	The audioProfile struct, initialized set As TRUE if it was found
*
*/
audioProfile_t initCorsairWirelessAudioXHCI()
{
